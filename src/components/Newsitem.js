      ...
      <div className='my-3'>
        <div className="card" style={{height: '30rem', boxShadow: '0px 0px 15 px 1px #161111',borderRadius: '22px'}}>
            ...
            <div className="card-body">
                ...
                <div className="mybtn">
                  <a rel=" noopener noreferrer" href={newsUrl}  target="_blank" className="btn btn-sm btn-dark" style={{backgroundColor:'#90ff88', fontWeight:'600', color:'black', boxShadow: '0px 1px 6px 0px #2412b7', border: '2px solid white'}}>Read More</a>
                </div>
            </div>
        </div>
      </div>
